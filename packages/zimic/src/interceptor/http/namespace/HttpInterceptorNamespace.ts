...
export class HttpInterceptorNamespaceDefault {
   ...
   * {@link https://github.com/zimicjs/zimic#httpcreateinterceptor `httpInterceptor.create()`}.
   *
...
class HttpInterceptorNamespace {
   ...
   * @see {@link https://github.com/zimicjs/zimic#httpcreateinterceptor `httpInterceptor.create()` API reference}
   */
