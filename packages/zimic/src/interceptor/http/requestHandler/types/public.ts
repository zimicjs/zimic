 ...
 *
 * @see {@link https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#http-handlerwithrestriction `handler.with()` API reference}
 */
 ...
 * {@link https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#http-interceptormethodpath `interceptor.<method>(path)`}
 * will be used.
 *
 * @see {@link https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#httprequesthandler `HttpRequestHandler` API reference}
 */
...
> {
   ...
   * @see {@link https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#http-handlermethod `handler.method()` API reference}
   */
  method: () => Method;
   ...
   *   matching requests.
   * @see {@link https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#http-handlerpath `handler.path()` API reference}
   */
  path: () => Path;
   ...
   *   status code.
   * @see {@link https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#http-handlerrespond `handler.respond()` API reference}
   */
   ...
   * [`handler.respond(declaration)`](https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#http-handlerresponddeclaration),
   ...
   * {@link https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#http-handlerrespond `handler.respond()`}.
   *
   * This method is useful to skip a handler. It is more gentle than
   * [`handler.clear()`](https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#http-handlerclear),
   ...
   * @see {@link https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#http-handlerbypass `handler.bypass()` API reference}
   */
   ...
   * [`handler.with(restriction)`](https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#http-handlerwithrestriction),
   ...
   * [`handler.bypass()`](https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#http-handlerbypass),
   ...
   * @see {@link https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#http-handlerclear `handler.clear()` API reference}
   */
   ...
   * {@link https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#saving-requests Saving intercepted requests}
   ...
   * @see {@link https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#http-handlerrequests `handler.requests()` API reference}
   */
  requests:
