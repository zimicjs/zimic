...
export interface HttpInterceptor<Schema extends HttpServiceSchema> {
   ...
   * @see {@link https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#http-interceptorbaseurl `interceptor.baseURL()` API reference}
   */
  baseURL: () => string;
   ...
   * @see {@link https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#http-interceptorisrunning `interceptor.isRunning()` API reference}
   */
  isRunning: () => boolean;
   ...
   * @see {@link https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#http-interceptorstart `interceptor.start()` API reference}
   */
  start: () => Promise<void>;
   ...
   *
   * @see {@link https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#http-interceptorstop `interceptor.stop()` API reference}
   */
  stop: () => Promise<void>;
   ...
   * @returns A GET
   *   {@link https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#httprequesthandler `HttpRequestHandler`}
   ...
   * @see {@link https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#http-interceptormethodpath `interceptor.<method>(path)` API reference}
   */
   ...
   *
   * @throws {NotStartedHttpInterceptorError} If the interceptor is not running.
   * @see {@link https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#http-interceptorclear `interceptor.clear()` API reference}
   */
  clear: () => void;
}
 ...
 * {@link https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#http-interceptorstart `interceptor.start()`}.
 *
 * @see {@link https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#httpinterceptor `HttpInterceptor` API reference}
 */
 ...
 * To intercept HTTP requests, the interceptor must have been started with
 * {@link https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#http-interceptorstart `interceptor.start()`}
 * and an {@link https://github.com/zimicjs/zimic/wiki/CLI:-%60zimic-server%60#zimic-server interceptor server} should be
 * running.
 *
 * @see {@link https://github.com/zimicjs/zimic/wiki/API-reference:-%60zimic-interceptor-http%60#httpinterceptor `HttpInterceptor` API reference}
 */
