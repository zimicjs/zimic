...
export async function declareDefaultMethodHttpInterceptorTests(options: RuntimeSharedHttpInterceptorTestsOptions) {
  ...
  describe.each(HTTP_METHODS_WITH_REQUEST_BODY)('Bodies: %s', (method) => {
