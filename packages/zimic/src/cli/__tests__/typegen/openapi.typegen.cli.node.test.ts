...
describe('Type generation (OpenAPI)', () => {
  ...
  describe.each([{ type: 'yaml' }, { type: 'json' }] as const)('Type: %s', (file) => {
    ...
    it('should generate types from a schema having components', async () => {
      ...
      expect(outputContent).toBe(
        [
          `import type { HttpSchema, HttpSearchParamSerialized, HttpHeaderSerialized } from '${TYPEGEN_IMPORT_FROM}';`,
          'export type MyServiceSchema = HttpSchema.Paths<{',
          "  '/pets': {",
          ...
          '    };',
          "    sortOrder: 'asc' | 'desc';",
          "    'x-rate-limit-remaining-other': MyServiceComponents['headers']['x-rate-limit-remaining'];",
          '  };',
          '  parameters: {',
          '    search: string | undefined;',
          '    limit: `${number}`;',
          '    archived: `${boolean}`;',
          "    order: HttpSearchParamSerialized<MyServiceComponents['schemas']['sortOrder']>;",
          "    'content-type': string;",
          "    'x-rate-limit-remaining': `${number}`;",
          "    'x-rate-limit-reset': `${boolean}`;",
          '  };',
          '  headers: {',
          "    'content-type': string | undefined;",
          "    'x-rate-limit-remaining': `${number}`;",
          "    'x-rate-limit-reset': `${boolean}`;",
          "    'x-rate-limit-remaining-other': HttpHeaderSerialized<",
          "      MyServiceComponents['schemas']['x-rate-limit-remaining-other']",
          '    >;',
          '  };',
          '}',
          ...
          '      headers: {',
          "        'content-type'?: MyServiceComponents['headers']['content-type'];",
          "        'x-rate-limit-remaining'?: MyServiceComponents['headers']['x-rate-limit-remaining'];",
          "        'x-rate-limit-reset'?: MyServiceComponents['headers']['x-rate-limit-reset'];",
          "        'parameter-content-type'?: MyServiceComponents['parameters']['content-type'];",
          "        'parameter-x-rate-limit-remaining'?: MyServiceComponents['parameters']['x-rate-limit-remaining'];",
          "        'parameter-x-rate-limit-reset'?: MyServiceComponents['parameters']['x-rate-limit-reset'];",
          "        'literal-content-type'?: string;",
          "        'literal-x-rate-limit-remaining'?: `${number}`;",
          "        'literal-x-rate-limit-reset'?: `${boolean}`;",
          '      };',
          '    };',
          '    response: {',
          '      201: {',
