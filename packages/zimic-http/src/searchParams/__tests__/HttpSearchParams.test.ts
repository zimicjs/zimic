...
describe('HttpSearchParams', () => {
  ...
  describe('Assign', () => {
    it('should support assigning search params', () => {
      const searchParams = new HttpSearchParams<{
        names?: string[];
        page?: `${number}`;
        orderBy?: string;
    ...
    it('should support assigning search params that override existing values', () => {
      const searchParams = new HttpSearchParams<{
        names?: string[];
        page?: `${number}`;
      }>({
    ...
    it('should not change the target search params if the source search params are empty', () => {
      const searchParams = new HttpSearchParams<{
        names?: string[];
      }>({
        names: ['User1'],
