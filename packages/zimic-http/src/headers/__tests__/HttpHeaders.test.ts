...
describe('HttpHeaders', () => {
  ...
  describe('Assign', () => {
    it('should support assigning headers', () => {
      const headers = new HttpHeaders<{
        accept?: string;
        'content-type'?: `application/${string}`;
      }>({ accept: '*/*' });
    ...
    it('should support assigning headers that override existing values', () => {
      const headers = new HttpHeaders<{
        accept?: string;
        'content-type'?: `application/${string}`;
      }>({
    ...
    it('should not change the target headers if the source headers are empty', () => {
      const headers = new HttpHeaders<{
        accept?: string;
      }>({ accept: '*/*' });
