...
describe('HttpFormData', async () => {
  ...
  describe('Assign', () => {
    it('should support assigning form data', () => {
      const formData = new HttpFormData<{
        file?: File;
        description?: string;
      }>();
      ...
      expect(formData.toObject()).toEqual({
        file,
      });
    ...
    it('should support assigning form data that override existing values', () => {
      const formData = new HttpFormData<{
        file?: File;
        description?: string;
      }>();
      ...
      otherFormData.set('description', `new ${description}`);
    ...
    it('should not change the target form data if the source form data is empty', () => {
