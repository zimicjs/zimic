...
describe('CLI > Server token', () => {
  ...
  const serverHelpOutput = [
    ...
    '  zimic-interceptor server token ls         List the authorized interceptor toke',
    '                                            ns.                  [aliases: list]',
    '  zimic-interceptor server token rm <token  Remove (invalidate) an interceptor t',
    '  Id>                                       oken. Existing connections will not',
    '                                            be affected, so restarting the serve',
    '                                            r is recommended to disconnect all i',
    '                                            nterceptors.       [aliases: remove]',
    '',
    'Options:',
