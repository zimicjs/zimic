...
export async function declareBinaryBodyHttpInterceptorTests(options: RuntimeSharedHttpInterceptorTestsOptions) {
  ...
  it.each([
    ...
    'application/octet-stream',
    'multipart/mixed',
  ] as const)('should support binary file bodies in intercepted requests: %s', async (contentType) => {
  ...
  it('should support binary array buffer bodies in intercepted requests', async () => {
    type MethodSchema = HttpSchema.Method<{
      request: {
        headers: { 'content-type': string };
        body: ArrayBuffer;
  ...
  it('should support binary stream bodies in intercepted requests', async () => {
    type MethodSchema = HttpSchema.Method<{
      request: {
        headers: { 'content-type': string };
        body: ReadableStream;
  ...
  it('should consider empty request or response binary bodies as blob', async () => {
    type MethodSchema = HttpSchema.Method<{
      request: {
        headers: { 'content-type': string };
        body?: Blob;
  ...
  it('should consider array buffer request bodies as blob', async () => {
    type MethodSchema = HttpSchema.Method<{
      request: {
        headers: { 'content-type': string };
        body: ArrayBuffer;
