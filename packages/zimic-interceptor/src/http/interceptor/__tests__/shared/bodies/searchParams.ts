...
export function declareSearchParamsBodyHttpInterceptorTests(options: RuntimeSharedHttpInterceptorTestsOptions) {
  ...
  it('should support intercepting requests having a URL search params body', async () => {
  ...
  it('should not show an error and skip parsing if the body of a request or response is defined as URL search params, but it is not valid', async () => {
    type MethodSchema = HttpSchema.Method<{
      request: {
        headers: { 'content-type': string };
        body: string;
  ...
  it('should consider empty request or response URL search params bodies as null', async () => {
    type MethodSchema = HttpSchema.Method<{
      request: {
        headers: { 'content-type': string };
        body?: HttpSearchParams<UserSearchParamsSchema>;
