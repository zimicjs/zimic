...
export async function declareFormDataBodyHttpInterceptorTests(options: RuntimeSharedHttpInterceptorTestsOptions) {
  ...
  it('should support intercepting requests having a form data body', async () => {
  ...
  it('should show an error and skip parsing if the body of a request or response is defined as form data, but it is not valid', async () => {
    type MethodSchema = HttpSchema.Method<{
      request: {
        headers: { 'content-type': string };
        body: string;
  ...
  it('should consider empty request or response form data bodies as form data', async () => {
    type MethodSchema = HttpSchema.Method<{
      request: {
        headers: { 'content-type': string };
        body?: HttpFormData<UserFormDataSchema>;
