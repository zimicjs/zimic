...
export async function declareJSONBodyHttpInterceptorTests(options: RuntimeSharedHttpInterceptorTestsOptions) {
  ...
  it('should support intercepting requests having a JSON body declared as a type', async () => {
  ...
  it('should support intercepting requests having a JSON body declared as an interface', async () => {
    type MethodSchema = HttpSchema.Method<{
      request: {
        headers: { 'content-type': string };
  ...
  it('should support intercepting requests having a JSON body declared as type or interface not strictly compatible with JSON', async () => {
  ...
  it('should support intercepting requests having a number as JSON body', async () => {
    type MethodSchema = HttpSchema.Method<{
      request: {
        headers: { 'content-type': string };
        body: number;
  ...
  it('should support intercepting requests having a boolean as JSON body', async () => {
    type MethodSchema = HttpSchema.Method<{
      request: {
        headers: { 'content-type': string };
        body: boolean;
  ...
  it('should try to parse the body of a request or response as JSON if no content type exists', async () => {
    type MethodSchema = HttpSchema.Method<{
      request: {
        headers: { 'content-type': string };
        body: UserAsType;
  ...
  it('should fallback the body of a request or response to text if could not be parsed as JSON and no content type exists', async () => {
    type MethodSchema = HttpSchema.Method<{
      request: {
        headers: { 'content-type': string };
        body: Blob;
    ...
    await usingHttpInterceptor<{
      ...
      const handler = await promiseIfRemote(
        interceptor.post('/users/:id').respond(async (request) => {
  ...
  it('should try to parse the body of a request or response as JSON if the body contains an unknown content type', async () => {
    type MethodSchema = HttpSchema.Method<{
      request: {
        headers: { 'content-type': string };
        body: UserAsType;
  ...
  it('should fallback the body of a request or response to text if could not be parsed as JSON and the content type is unknown', async () => {
    type MethodSchema = HttpSchema.Method<{
      request: {
        headers: { 'content-type': string };
        body: Blob;
  ...
  it('should show an error and skip parsing if the body of a request or response is defined as JSON, but it is not valid', async () => {
    type MethodSchema = HttpSchema.Method<{
      request: {
        headers: { 'content-type': string };
        body: string;
  ...
  it.each(['', undefined, null])('should consider empty request or response JSON bodies as null', async (body) => {
    type MethodSchema = HttpSchema.Method<{
      request: {
        headers: { 'content-type': string };
        body?: string | null;
