...
of the main concepts powering Zimic is the idea of a [centralized schema](/docs/zimic-http/guides/1-http-schemas.md),
which serves as a source of truth for the structure of your HTTP endpoints. It is declared in a readable format and can
be [autogenerated from OpenAPI](/docs/zimic-http/guides/3-typegen.mdx).
...
- :bulb: **Type generation**
  ...
  [typegen CLI](/docs/zimic-http/guides/3-typegen.mdx).
