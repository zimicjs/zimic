...
`@zimic/http` has typegen support for [OpenAPI](https://www.openapis.org) documentations. The result is a ready-to-use
...
[`@zimic/interceptor` interceptors](/docs/zimic-interceptor/guides/11-typegen.mdx#using-a-generated-schema).
