...
An [HTTP schema](/docs/zimic-http/guides/1-http-schemas.md) is one of the main aspects of `@zimic/http`. It allows you
to define the structure of an API in readable TypeScript types. [`@zimic/fetch`](/docs/zimic-fetch/1-index.md) and
...
`@zimic/http` has typegen support, so you can use the [CLI](/docs/zimic-http/cli/1-typegen.md) to infer types from
[OpenAPI](https://www.openapis.org) documentations. The result is a ready-to-use schema that can be used directly by
[`@zimic/fetch`](/docs/zimic-fetch/1-index.md), [`@zimic/interceptor`](/docs/zimic-interceptor/1-index.md), and your
application code.
