...
For JSON-compatible schemas, `WebSocketMessageData` is the stringified representation of the schema. For `string`, `Blob`, and `BufferSource` schemas, it preserves the original type.
