...
1. **declaration**: `HttpRequestHandlerResponseDeclaration<MethodSchema, StatusCode>`
   ...
   **Returns**: `Promise<HttpRequestHandlerResponseDeclaration<MethodSchema, StatusCode>>`
