...
1. **declaration**: `HttpRequestHandlerResponseStaticDeclaration<MethodSchema, StatusCode> | HttpRequestHandlerResponseComputedDeclaration<Path, MethodSchema, StatusCode>`
   ...
   `HttpRequestHandlerResponseDeclaration` was renamed to `HttpRequestHandlerResponseStaticDeclaration`, and `HttpRequestHandlerResponseDeclarationFactory` was renamed to `HttpRequestHandlerResponseComputedDeclaration`. The previous names remain available as aliases and are not deprecated.
