...
interceptor, and the method, path, [restrictions](/docs/zimic-interceptor/api/3-http-request-handler.md#handlerwith),
and [limits on the number of requests](/docs/zimic-interceptor/api/3-http-request-handler.md#handlertimes) of the
handler.
...
Creates a GET [`HttpRequestHandler`](/docs/zimic-interceptor/api/3-http-request-handler.md) for a path declared in the
interceptor schema.
...
Creates a POST [`HttpRequestHandler`](/docs/zimic-interceptor/api/3-http-request-handler.md) for a path declared in the
interceptor schema.
...
Creates a PUT [`HttpRequestHandler`](/docs/zimic-interceptor/api/3-http-request-handler.md) for a path declared in the
interceptor schema.
...
Creates a PATCH [`HttpRequestHandler`](/docs/zimic-interceptor/api/3-http-request-handler.md) for a path declared in the
interceptor schema.
...
Creates a DELETE [`HttpRequestHandler`](/docs/zimic-interceptor/api/3-http-request-handler.md) for a path declared in
...
Creates a HEAD [`HttpRequestHandler`](/docs/zimic-interceptor/api/3-http-request-handler.md) for a path declared in the
interceptor schema.
...
Creates a OPTIONS [`HttpRequestHandler`](/docs/zimic-interceptor/api/3-http-request-handler.md) for a path declared in
the interceptor schema.
...
including a stack trace to the [`handler.times()`](/docs/zimic-interceptor/api/3-http-request-handler.md#handlertimes)
...
that did not match a handler with [restrictions](/docs/zimic-interceptor/api/3-http-request-handler.md#handlerwith).
...
Clears the interceptor and all of its [`HttpRequestHandler`](/docs/zimic-interceptor/api/3-http-request-handler.md)
