...
WebSocket mocks, see the [WebSocket interceptor guide](/docs/zimic-interceptor/guides/ws/1-websocket-interceptors.md)
and [API reference](/docs/interceptor/api).
...
[WebSocket examples](/docs/zimic-interceptor/guides/ws/1-websocket-interceptors.md) use `@zimic/ws` schemas. When
...
[WebSocket interceptor guide](/docs/zimic-interceptor/guides/ws/1-websocket-interceptors.md) while the dedicated API
...
- Use the [WebSocket interceptor guide](/docs/zimic-interceptor/guides/ws/1-websocket-interceptors.md) when your tests
  need to mock typed WebSocket message flows with `@zimic/ws`.
