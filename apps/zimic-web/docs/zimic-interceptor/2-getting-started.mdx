...
If you are using a [remote interceptor](/docs/zimic-interceptor/guides/2-remote-http-interceptors.md), the `baseURL`
should point to a running [interceptor server](/docs/zimic-interceptor/cli/1-server.md), which is configured by the
interceptor to handle requests. Learn more about
[starting remote HTTP interceptors](/docs/zimic-interceptor/guides/2-remote-http-interceptors.md#starting-an-interceptor).
