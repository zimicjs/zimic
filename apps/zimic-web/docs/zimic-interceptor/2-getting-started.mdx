...
option is the base URL of your API and defines the scope of the interceptor.
...
Learn more about [local interceptors](/docs/zimic-interceptor/guides/1-local-http-interceptors.md) and
[remote interceptors](/docs/zimic-interceptor/guides/2-remote-http-interceptors.md) to see which one fits your needs. We
...
If you are using a [remote interceptor](/docs/zimic-interceptor/guides/2-remote-http-interceptors.md), it's necessary to
have a [interceptor server](/docs/zimic-interceptor/cli/1-server.md) running before starting the interceptor.
...
Many operations in [remote interceptors](/docs/zimic-interceptor/guides/2-remote-http-interceptors.md) are
