...
WebSocket mocks, see the
[WebSocket interceptor guide](/docs/zimic-interceptor/guides/ws/1-local-websocket-interceptors.md) and
...
[WebSocket examples](/docs/zimic-interceptor/guides/ws/1-local-websocket-interceptors.md) use
[`@zimic/ws` schemas](/docs/ws/guides/schemas). When upgrading `@zimic/interceptor` to a new version, consider upgrading
both schema packages as well to ensure that the versions are compatible.

The protocol peers are optional so single-protocol projects can install only the schema package they use. Dedicated
single-protocol examples will provide empirical package-isolation validation in a future release.
...
[WebSocket interceptor guide](/docs/zimic-interceptor/guides/ws/1-local-websocket-interceptors.md) and the
...
- Use the [WebSocket interceptor guide](/docs/zimic-interceptor/guides/ws/1-local-websocket-interceptors.md) when your
  tests need to mock typed WebSocket message flows with [`@zimic/ws`](/docs/ws).
