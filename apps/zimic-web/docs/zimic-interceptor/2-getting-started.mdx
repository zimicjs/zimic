...
[`interceptor.start()`](/docs/zimic-interceptor/api/2-http-interceptor.md#interceptorstart). This is usually done before
using the interceptor, such as in a `beforeAll` hook in your test suite.
