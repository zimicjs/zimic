...
`@zimic/interceptor` uses [`@zimic/http`](/docs/zimic-http/1-index.md), which can infer types from [OpenAPI](https://www.openapis.org) documentation and generate ready-to-use [schemas](/docs/zimic-http/guides/1-schemas.md) to type your `@zimic/interceptor` interceptors.
