...
Request bodies can be declared in your [schema](/docs/zimic-http/guides/1-schemas.md) using the `request.body` property. Then, they will be available in the `body` property, such as in [`handler.with()`](/docs/zimic-interceptor/api/3-http-request-handler.mdx#handlerwith), [computed responses](/docs/zimic-interceptor/api/3-http-request-handler.mdx#handlerrespond), and [`handler.requests`](/docs/zimic-interceptor/api/3-http-request-handler.mdx#handlerrequests).
...
When working with large files or chunked data, you can use [`ReadableStream`](https://developer.mozilla.org/docs/Web/API/ReadableStream) to handle streamed request bodies.
...
Then, they will be available in the `body` property, such as in [`handler.respond()`](/docs/zimic-interceptor/api/3-http-request-handler.mdx#handlerrespond).
...
To use a `FormData` response body, declare its type in your [schema](/docs/zimic-http/guides/1-schemas.md) using the [`HttpFormData`](/docs/zimic-http/api/4-http-form-data.md).
...
Binary response bodies can be declared with types such as [`Blob`](https://developer.mozilla.org/docs/Web/API/Blob), [`ArrayBuffer`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer), and [`ReadableStream`](https://developer.mozilla.org/docs/Web/API/ReadableStream).
...
Similarly to [request streaming](#request-streaming), you can stream response bodies using [`ReadableStream`](https://developer.mozilla.org/docs/Web/API/ReadableStream).
