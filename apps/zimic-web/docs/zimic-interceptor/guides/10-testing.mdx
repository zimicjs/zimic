...
[`interceptor.with()`](/docs/zimic-interceptor/api/2-http-interceptor.md#interceptorwith) and
[`interceptor.times()`](/docs/zimic-interceptor/api/2-http-interceptor.md#interceptortimes).
...
This is because many operations in [remote interceptors](/docs/zimic-interceptor/guides/2-remote-interceptors.md) are
...
[local interceptors](/docs/zimic-interceptor/guides/1-local-interceptors.md), which have mostly synchronous operations.
...
With [local interceptors](/docs/zimic-interceptor/guides/1-local-interceptors.md), racing conditions between test
...
[Remote interceptors](/docs/zimic-interceptor/guides/2-remote-interceptors.md) use an
