...
[schemas](/docs/zimic-http/guides/1-http-schemas.md) to type your `@zimic/interceptor` interceptors.

## OpenAPI

To generate a schema from an local OpenAPI document, use the [`@zimic/http` CLI](/docs/zimic-http/cli/1-typegen.md):
