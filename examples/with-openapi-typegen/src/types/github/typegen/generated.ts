...
export interface GitHubComponents {
  schemas: {
    ...
    repository: {
      ...
      name: string;
      full_name: string;
      license: null | GitHubComponents['schemas']['license-simple'];
      forks: number;
      permissions?: {
        admin: boolean;
        pull: boolean;
    ...
    'full-repository': {
      ...
      allow_rebase_merge?: boolean;
      template_repository?: null | GitHubComponents['schemas']['repository'];
      ...
      license: null | GitHubComponents['schemas']['license-simple'];
      organization?: null | GitHubComponents['schemas']['simple-user'];
