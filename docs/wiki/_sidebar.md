...
- [CLI reference](cli‐zimic)
  - [`zimic-interceptor browser`](cli‐zimic‐browser)
    - [`zimic-interceptor browser init`](cli‐zimic‐browser#zimic-browser-init)
  - [`zimic-interceptor server`](cli‐zimic‐server)
    - [`zimic-interceptor server start`](cli‐zimic‐server#zimic-server-start)
    - [Programmatic usage](cli‐zimic‐server#programmatic-usage)
  - [`zimic-http typegen`](cli‐zimic‐typegen)
    - [`zimic-http typegen openapi`](cli‐zimic‐typegen#zimic-typegen-openapi)
